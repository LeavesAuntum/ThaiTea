...
import { Heading, RowType, Toggle, Text, Flex, useMatchBreakpoints } from '@rimauswap-libs/uikit'
...
const Farms: React.FC = () => {
  ...
  const [viewMode, setViewMode] = usePersistState(ViewMode.TABLE, { localStorageKey: 'rimauswap_farm_view' })
        ...
        <ControlContainer>

          {
            ...
            <>
              ...
              <FilterContainer>
                <LabelWrapper>
                  <Text mr="10px" textTransform="uppercase">{t('Sort by')}</Text>
                  <Select
                    options={[
                      {
                        label: t('Hot'),
